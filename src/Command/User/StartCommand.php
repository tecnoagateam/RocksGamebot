...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= __('To begin or join @Alexa_Help bot owner @Dr_Asad_Ali contact me to get repo, start a message with {USAGE} in any of your chats or click the {BUTTON} button and then select a chat to play in.', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
